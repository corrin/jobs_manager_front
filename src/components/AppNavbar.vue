    ...
    <div class="flex items-center justify-between h-10 md:h-8 lg:h-auto">
      ...
      <div class="hidden lg:flex items-center space-x-6">
        ...
        <div class="relative group">
          <button @click="toggleDropdown('timesheets')"
          ...
          <Transition enter-active-class="transition-all duration-300 ease-out"
            ...
            <div v-if="activeDropdown === 'timesheets'"
              ...
              <div class="py-1">
                ...
                <router-link to="/timesheets/daily"
                  class="flex items-center px-4 py-2 text-sm text-gray-700 hover:text-blue-600 hover:bg-blue-50 font-medium transition-all">
                  <Calendar class="w-4 h-4 mr-3" /> Daily Overview
                </router-link>
                <router-link to="/timesheets/weekly"
                  class="flex items-center px-4 py-2 text-sm text-gray-700 hover:text-blue-600 hover:bg-blue-50 font-medium transition-all">
        ...
        <div class="relative" @click.stop>
          <button @click="toggleDropdown('purchases')"
          ...
          <Transition enter-active-class="transition-all duration-300 ease-out"
            ...
            leave-active-class="transition-all duration-200 ease-in"
            leave-from-class="opacity-100 translate-y-0 scale-100" leave-to-class="opacity-0 -translate-y-2 scale-95">
            <div v-if="activeDropdown === 'purchases'"
              class="absolute top-full left-0 mt-1 w-56 bg-white rounded-md shadow-lg border border-gray-200 z-[60]">
              <RouterLink to="/purchasing/po"
                class="flex items-center px-4 py-2 text-sm text-gray-700 hover:text-blue-600 hover:bg-blue-50 font-medium transition-all">
                <FileText class="w-4 h-4 mr-2" /> Purchase Orders
              </RouterLink>
              <RouterLink to="/purchasing/stock"
                class="flex items-center px-4 py-2 text-sm text-gray-700 hover:text-blue-600 hover:bg-blue-50 font-medium transition-all">
                <Box class="w-4 h-4 mr-2" /> Use Stock
              </RouterLink>
              <RouterLink to="/purchasing/pricing"
                class="flex items-center px-4 py-2 text-sm text-gray-700 hover:text-blue-600 hover:bg-blue-50 font-medium transition-all">
                <UploadCloud class="w-4 h-4 mr-2" /> Upload Supplier Pricing
              </RouterLink>
              <RouterLink to="/purchasing/mappings"
                class="flex items-center px-4 py-2 text-sm text-gray-700 hover:text-blue-600 hover:bg-blue-50 font-medium transition-all">
        ...
        <div class="relative" @click.stop>
          <button @click="toggleDropdown('safety')"
            class="flex items-center text-gray-700 hover:text-blue-600 transition-colors text-sm font-medium px-3 py-2 rounded-md duration-200">
          ...
          <Transition enter-active-class="transition-all duration-300 ease-out"
            ...
            <div v-if="activeDropdown === 'safety'"
              ...
              <button @click="showNotImplemented('Staff Training')"
                class="w-full flex items-center px-4 py-2 text-sm text-gray-400 hover:text-gray-500 hover:bg-gray-50 font-medium transition-all">
        ...
        <div class="relative" @click.stop>
          ...
          <Transition enter-active-class="transition-all duration-300 ease-out"
            ...
            leave-active-class="transition-all duration-200 ease-in"
            leave-from-class="opacity-100 translate-y-0 scale-100" leave-to-class="opacity-0 -translate-y-2 scale-95">
            <div v-if="activeDropdown === 'reports'"
              class="absolute top-full left-0 mt-1 w-56 bg-white rounded-md shadow-lg border border-gray-200 z-[60]">
              <router-link to="/reports/clients"
                class="flex items-center px-4 py-2 text-sm text-gray-700 hover:text-blue-600 hover:bg-blue-50 font-medium transition-all">
                <Users class="w-4 h-4 mr-2" /> Clients
              </router-link>
              <router-link to="/reports/kpi"
                class="flex items-center px-4 py-2 text-sm text-gray-700 hover:text-blue-600 hover:bg-blue-50 font-medium transition-all">
                <BarChart3 class="w-4 h-4 mr-2" /> KPI Reports
              </router-link>
              <router-link to="/reports/job-aging"
                class="flex items-center px-4 py-2 text-sm text-gray-700 hover:text-blue-600 hover:bg-blue-50 font-medium transition-all">
                <Clock class="w-4 h-4 mr-2" /> Job Aging Report
              </router-link>
              <router-link to="/reports/staff-performance"
                class="flex items-center px-4 py-2 text-sm text-gray-700 hover:text-blue-600 hover:bg-blue-50 font-medium transition-all">
                <Users class="w-4 h-4 mr-2" /> Staff Performance
              </router-link>
              <router-link to="/reports/sales-forecast"
                class="flex items-center px-4 py-2 text-sm text-gray-700 hover:text-blue-600 hover:bg-blue-50 font-medium transition-all">
                <TrendingUp class="w-4 h-4 mr-2" /> Sales Forecast
              </router-link>
              <router-link to="/reports/profit-and-loss"
                class="flex items-center px-4 py-2 text-sm text-gray-700 hover:text-blue-600 hover:bg-blue-50 font-medium transition-all">
              ...
              <router-link to="/reports/data-quality/archived-jobs"
                class="flex items-center px-4 py-2 text-sm text-gray-700 hover:text-blue-600 hover:bg-blue-50 font-medium transition-all">
        ...
        <div class="relative" @click.stop v-if="userInfo.is_office_staff">
          <button @click="toggleDropdown('admin')"
            class="flex items-center text-gray-700 hover:text-blue-600 transition-colors text-sm font-medium px-3 py-2 rounded-md duration-200">
          ...
          <Transition enter-active-class="transition-all duration-300 ease-out"
            ...
            <div v-if="activeDropdown === 'admin'"
              ...
              <router-link to="/admin/company"
                class="flex items-center px-4 py-2 text-sm text-gray-700 hover:text-blue-600 hover:bg-blue-50 font-medium transition-all">
                <Building2 class="w-4 h-4 mr-2" /> Company
              </router-link>
              <router-link to="/admin/archive-jobs"
                class="flex items-center px-4 py-2 text-sm text-gray-700 hover:text-blue-600 hover:bg-blue-50 font-medium transition-all">
                <Archive class="w-4 h-4 mr-2" /> Archive Jobs
              </router-link>
              <router-link to="/admin/month-end"
                class="flex items-center px-4 py-2 text-sm text-gray-700 hover:text-blue-600 hover:bg-blue-50 font-medium transition-all">
              ...
              <router-link to="/admin/django-jobs"
                class="flex items-center px-4 py-2 text-sm text-gray-700 hover:text-blue-600 hover:bg-blue-50 font-medium transition-all">
                <Cog class="w-4 h-4 mr-2" /> Django Jobs
              </router-link>
              <router-link to="/admin/ai-providers"
                class="flex items-center px-4 py-2 text-sm text-gray-700 hover:text-blue-600 hover:bg-blue-50 font-medium transition-all">
                <Brain class="w-4 h-4 mr-2" /> AI Providers
              </router-link>
              <router-link to="/admin/uat"
                class="flex items-center px-4 py-2 text-sm text-gray-700 hover:text-blue-600 hover:bg-blue-50 font-medium transition-all">
          ...
          <div class="grid grid-cols-1 gap-3">
            <div class="space-y-3">
              <router-link to="/jobs/create"
                ...
                data-automation-id="AppNavbar-create-job-mobile" @click="closeMobileMenu">Create Job</router-link>
              <router-link to="/timesheets/entry"
                class="flex items-center px-3 py-2 text-gray-700 hover:text-blue-600 hover:bg-blue-50 rounded-md transition-all"
                @click="closeMobileMenu">Timesheet Entry</router-link>
              <router-link to="/timesheets/daily"
                class="flex items-center px-3 py-2 text-gray-700 hover:text-blue-600 hover:bg-blue-50 rounded-md transition-all"
                @click="closeMobileMenu">Daily Overview</router-link>
            </div>
            ...
            <div class="space-y-2">
              <div class="bg-gray-50 rounded-md">
                <button @click="toggleMobileSection('purchases')"
                ...
                <Transition enter-active-class="transition-all duration-200 ease-out"
                  ...
                  leave-active-class="transition-all duration-200 ease-in" leave-from-class="opacity-100 max-h-40"
                  ...
                  <div v-if="mobileSections.purchases" class="overflow-hidden">
                    <div class="px-3 pb-2 space-y-1">
                      <RouterLink to="/purchasing/po"
                        ...
                        @click="closeMobileMenu">Purchase Orders</RouterLink>
                      <RouterLink to="/purchasing/stock"
                        class="block px-2 py-1.5 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded transition-all"
                        @click="closeMobileMenu">Use Stock</RouterLink>
                      <RouterLink to="/purchasing/pricing"
                        class="block px-2 py-1.5 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded transition-all"
                        @click="closeMobileMenu">Upload Supplier Pricing</RouterLink>
                      <RouterLink to="/purchasing/mappings"
                        class="block px-2 py-1.5 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded transition-all"
                        @click="closeMobileMenu">Product Mappings</RouterLink>
                    </div>
                  </div>
                </Transition>
              </div>
              ...
              <div class="bg-gray-50 rounded-md">
                <button @click="toggleMobileSection('safety')"
                  class="w-full flex items-center justify-between px-3 py-2 text-gray-700 hover:text-blue-600 transition-colors font-medium">
                  Process
                  <ChevronDown :class="[
                    'h-4 w-4 transition-transform duration-200',
                ...
                <Transition enter-active-class="transition-all duration-200 ease-out"
                  ...
                  <div v-if="mobileSections.safety" class="overflow-hidden">
                    <div class="px-3 pb-2 space-y-1">
                      <RouterLink to="/safety/jsa"
                        class="block px-2 py-1.5 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded transition-all"
                        @click="closeMobileMenu">Job Safety Analyses</RouterLink>
                      <RouterLink to="/safety/swp"
                        class="block px-2 py-1.5 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded transition-all"
                        @click="closeMobileMenu">Safe Work Procedures</RouterLink>
                      <div class="border-t border-gray-200 my-1"></div>
                      <button @click="showNotImplementedMobile('Machine Maintenance Schedule')"
                      ...
                      <button @click="showNotImplementedMobile('Staff Training')"
                        class="block w-full text-left px-2 py-1.5 text-sm text-gray-400 hover:text-gray-500 hover:bg-gray-50 rounded transition-all">
                        Staff Training
                      </button>
                    </div>
              ...
              <div class="bg-gray-50 rounded-md">
                <button @click="toggleMobileSection('reports')"
                  class="w-full flex items-center justify-between px-3 py-2 text-gray-700 hover:text-blue-600 transition-colors font-medium">
                  Reports
                  <ChevronDown :class="[
                    'h-4 w-4 transition-transform duration-200',
                ...
                <Transition enter-active-class="transition-all duration-200 ease-out"
                  ...
                  <div v-if="mobileSections.reports" class="overflow-hidden">
                    <div class="px-3 pb-2 space-y-1">
                      <router-link to="/reports/clients"
                        class="block px-2 py-1.5 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded transition-all"
                        @click="closeMobileMenu">Clients</router-link>
                      <router-link to="/reports/kpi"
                        class="block px-2 py-1.5 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded transition-all"
                        @click="closeMobileMenu">KPI Reports</router-link>
                      <router-link to="/reports/job-aging"
                        class="block px-2 py-1.5 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded transition-all"
                        @click="closeMobileMenu">Job Aging Report</router-link>
                      <router-link to="/reports/staff-performance"
                        class="block px-2 py-1.5 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded transition-all"
                        @click="closeMobileMenu">Staff Performance</router-link>
                      <router-link to="/reports/sales-forecast"
                        class="block px-2 py-1.5 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded transition-all"
                        @click="closeMobileMenu">Sales Forecast</router-link>
                      <router-link to="/reports/profit-and-loss"
                        class="block px-2 py-1.5 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded transition-all"
                        @click="closeMobileMenu">Profit & Loss (Xero)</router-link>
                      ...
                      <router-link to="/reports/data-quality/archived-jobs"
                        class="block px-2 py-1.5 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded transition-all"
                        @click="closeMobileMenu">Archived Jobs Validation</router-link>
                    </div>
                  </div>
                </Transition>
              </div>
              ...
              <div class="bg-gray-50 rounded-md" v-if="userInfo.is_office_staff">
                <button @click="toggleMobileSection('admin')"
                  class="w-full flex items-center justify-between px-3 py-2 text-gray-700 hover:text-blue-600 transition-colors font-medium">
                  Admin
                ...
                <Transition enter-active-class="transition-all duration-200 ease-out"
                  enter-from-class="opacity-0 max-h-0" enter-to-class="opacity-100 max-h-40"
                  leave-active-class="transition-all duration-200 ease-in" leave-to-class="opacity-0 max-h-0">
                  <div v-if="mobileSections.admin" class="overflow-hidden">
                    <router-link to="/xero" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50"
                      @click="closeMobileMenu">
                      Xero
                    </router-link>
                    <div class="border-t border-gray-200 my-1 mx-2"></div>
                    <router-link to="/admin/staff" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50"
                      @click="closeMobileMenu">
                      Staff
                    </router-link>
                    <router-link to="/admin/company" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50"
                      @click="closeMobileMenu">
                      Company
                    </router-link>
                    <router-link to="/admin/archive-jobs" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50"
                      @click="closeMobileMenu">
                      Archive Jobs
                    </router-link>
                    <router-link to="/admin/month-end" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50"
                      @click="closeMobileMenu">
                      Month-End
                    </router-link>
                    <router-link to="/admin/errors" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50"
                      @click="closeMobileMenu">
                      App Errors
                    </router-link>
                    <router-link to="/admin/django-jobs" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50"
                      @click="closeMobileMenu">
                      Django Jobs
                    </router-link>
                    <router-link to="/admin/ai-providers" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50"
                      @click="closeMobileMenu">
                      AI Providers
                    </router-link>
                    <router-link to="/admin/uat" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50"
                      @click="closeMobileMenu">
                      Manage UAT
                    </router-link>
                  </div>

    ...
    <div class="flex items-center justify-between h-10 md:h-8 lg:h-auto">
      ...
      <div class="flex items-center">
        ...
        <router-link to="/kanban"
          class="text-sm md:text-sm lg:text-xl font-bold text-gray-900 hover:text-blue-600 transition-colors">Jobs
          Manager</router-link>
      </div>

      <!-- Desktop Navigation (Large screens only) -->
      <div class="hidden lg:flex items-center space-x-6">
        <router-link to="/jobs/create" class="text-gray-700 hover:text-blue-600 transition-colors text-sm">Create
          Job</router-link>
        <!-- Timesheet Dropdown -->
          ...
          <div class="grid grid-cols-1 gap-3">
            ...
            <div class="space-y-3">
              <router-link to="/jobs/create"
                ...
                @click="closeMobileMenu">Create Job</router-link>
              <router-link to="/timesheets/entry"
                class="flex items-center px-3 py-2 text-gray-700 hover:text-blue-600 hover:bg-blue-50 rounded-md transition-all"
            ...
            <div class="space-y-2">
              ...
              <div class="bg-gray-50 rounded-md">
                <button @click="toggleMobileSection('purchases')"
                  ...
                  Purchases
                  <ChevronDown
                    :class="['h-4 w-4 transition-transform duration-200', mobileSections.purchases ? 'rotate-180' : '']" />
                </button>
                  ...
                  <div v-if="mobileSections.purchases" class="overflow-hidden">
                    <div class="px-3 pb-2 space-y-1">
                      <a href="#"
                        ...
                        @click="closeMobileMenu">Purchase Orders</a>
                      <a href="#"
                        class="block px-2 py-1.5 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded transition-all"
                        @click="closeMobileMenu">Delivery Receipts</a>
                      <a href="#"
                        class="block px-2 py-1.5 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded transition-all"
                        @click="closeMobileMenu">Use Stock</a>
                      <a href="#"
                        class="block px-2 py-1.5 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded transition-all"
                        @click="closeMobileMenu">Upload Supplier Pricing</a>
                    </div>
                  </div>
                </Transition>
              </div>
              ...
              <div class="bg-gray-50 rounded-md">
                <button @click="toggleMobileSection('reports')"
                  ...
                  Reports
                  <ChevronDown
                    :class="['h-4 w-4 transition-transform duration-200', mobileSections.reports ? 'rotate-180' : '']" />
                </button>
                <Transition enter-active-class="transition-all duration-200 ease-out"
                  enter-from-class="opacity-0 max-h-0" enter-to-class="opacity-100 max-h-40"
                  leave-active-class="transition-all duration-200 ease-in" leave-from-class="opacity-100 max-h-40"
                  ...
                  <div v-if="mobileSections.reports" class="overflow-hidden">
                    <div class="px-3 pb-2 space-y-1">
                      <a href="#"
                        class="block px-2 py-1.5 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded transition-all"
                        @click="closeMobileMenu">KPI Reports</a>
                    </div>
                  </div>
                </Transition>
              </div>
              ...
              <div class="bg-gray-50 rounded-md">
                <button @click="toggleMobileSection('admin')"
                  ...
                  Admin
                  <ChevronDown
                    :class="['h-4 w-4 transition-transform duration-200', mobileSections.admin ? 'rotate-180' : '']" />
                </button>
                <Transition enter-active-class="transition-all duration-200 ease-out"
                  enter-from-class="opacity-0 max-h-0" enter-to-class="opacity-100 max-h-48"
                  leave-active-class="transition-all duration-200 ease-in" leave-from-class="opacity-100 max-h-48"
                  leave-to-class="opacity-0 max-h-0">
                  <div v-if="mobileSections.admin" class="overflow-hidden">
                    <div class="px-3 pb-2 space-y-1">
                      <a href="#"
                        class="block px-2 py-1.5 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded transition-all"
                        @click="closeMobileMenu">Run Month End</a>
                      <a href="#"
                        class="block px-2 py-1.5 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded transition-all"
                        @click="closeMobileMenu">Edit Staff</a>
                      <a href="#"
                        class="block px-2 py-1.5 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded transition-all"
                        @click="closeMobileMenu">Edit Company Defaults</a>
                      <a href="#"
                        class="block px-2 py-1.5 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded transition-all"
                        @click="closeMobileMenu">Archive Complete Jobs</a>
                    </div>
                  </div>
                </Transition>
              </div>

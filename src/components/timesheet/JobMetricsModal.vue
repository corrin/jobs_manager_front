    ...
    <DialogContent class="max-w-3xl max-h-[90vh] overflow-y-auto">      <DialogHeader>
      ...
      <div class="mt-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div class="bg-purple-50 rounded-lg p-4 flex flex-col items-center">
            ...
            <div class="text-2xl font-bold text-purple-700 mb-1">{{ completedStaff }}/{{ staffCount }}</div>
      ...
      <div class="mt-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div class="text-2xl font-bold text-orange-700 mb-1">{{ metrics.total_estimated_hours ?? '--' }}</div>
        ...
        <div class="bg-emerald-50 rounded-lg p-4 flex flex-col items-center">
          <h4 class="text-sm font-semibold text-emerald-900 mb-2 flex items-center">
            ...
            Total Revenue
          </h4>          <div class="text-2xl font-bold text-emerald-700 mb-1">${{ metrics.total_revenue ?? '--' }}</div>
          <div class="text-xs text-gray-500">All jobs</div>
        </div>
      </div>
      </div>

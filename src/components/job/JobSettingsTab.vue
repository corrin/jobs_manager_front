  ...
  <div class="h-full flex flex-col">
    ...
    <div class="flex-1 flex items-center justify-center -mt-8">
      <div class="relative w-[400px] h-[320px] sm:w-[500px] sm:h-[320px]">
        ...
        <div class="absolute flex flex-col items-center" style="top: -10px; left: 50%; transform: translateX(-50%);">
          <button 
          ...
          <div class="text-center mt-2">
            <span class="block text-sm font-semibold text-gray-700 whitespace-nowrap">Job Settings</span>
            <span class="block text-xs text-gray-500">Configure details</span>
          </div>
        </div>
        
        <!-- Button Container: Workflow (Top Right) -->
        <div class="absolute flex flex-col items-center" style="top: 20%; right: 0; transform: translateY(-50%);">
          <button 
          ...
          <div class="text-center mt-2">
            <span class="block text-sm font-semibold text-gray-700 whitespace-nowrap">Workflow</span>
            <span class="block text-xs text-gray-500">Manage status</span>
          </div>
        </div>
        
        <!-- Button Container: History (Bottom Right) -->
        <div class="absolute flex flex-col items-center" style="bottom: 20%; right: 0; transform: translateY(50%);">
          <button 
        ...
        <div class="absolute flex flex-col items-center" style="bottom: -10px; left: 50%; transform: translateX(-50%);">
          <button 
          ...
          <div class="text-center mt-2">
            <span class="block text-sm font-semibold text-gray-700 whitespace-nowrap">Attachments</span>
            <span class="block text-xs text-gray-500">Manage files</span>
          </div>
        </div>
        
        <!-- Button Container: Print Job (Bottom Left) -->
        <div class="absolute flex flex-col items-center" style="bottom: 20%; left: 0; transform: translateY(50%);">
          <button 
            @click="$emit('open-pdf')"
            class="w-20 h-20 flex flex-col items-center justify-center rounded-full bg-white border-2 border-gray-200 text-gray-500 cursor-pointer transition-all duration-200 ease-in-out shadow-md hover:bg-gray-50 hover:border-gray-300 hover:shadow-lg hover:scale-105"
          >
          ...
          <div class="text-center mt-2">
            <span class="block text-sm font-semibold text-gray-700 whitespace-nowrap">Print Job</span>
            <span class="block text-xs text-gray-500">Generate PDF</span>
          </div>
        </div>
        
        <!-- Button Container: Quoting Chat (Top Left) -->
        <div class="absolute flex flex-col items-center" style="top: 20%; left: 0; transform: translateY(-50%);">
          <button 
          ...
          <div class="text-center mt-2">
            <span class="block text-sm font-semibold text-gray-700 whitespace-nowrap">Quoting Chat</span>
...
const emit = defineEmits<JobSettingsTabEmits>()

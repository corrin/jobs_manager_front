...
import type { CompanyDefaults } from '@/services/job-rest.service'
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
const handleTaskSaved = (taskData: unknown, addAnother: boolean) => {
...
const handleMaterialSaved = (materialData: unknown, addAnother: boolean) => {
  ...
  <div>
    <DropdownMenu>
      ...
      <DropdownMenuContent class="w-56">
        ...
        <DropdownMenuItem @click="openNewMaterialModal">
          <!-- Removido disabled -->
